    ...
    kBraveShieldsAdBlockSubscriptionTrafficAnnotation =
        ...
        semantics {
          ...
          trigger:
            ...
            "for a particular list can also be triggered in asil://adblock."
          data: "The URL endpoint provided by the user in asil://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "asil://adblock page's custom list subscription section."
