...
const char kBraveUIWalletOnboardingURL[] = "asil://wallet/crypto/onboarding";
const char kBraveUIWalletAccountCreationURL[] =
    "asil://wallet/crypto/accounts/add-account/create/";
...
const char kExtensionSettingsURL[] = "asil://settings/extensions";
const char kWalletSettingsURL[] = "asil://settings/wallet";
...
const char kFederatedInternalsURL[] = "asil://federated-internals";
