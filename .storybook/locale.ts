...
let locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' Asil Software. Asil is a registered trademark of Asil Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this Asil Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from Asil in the event of data loss on your device.',
  ads: 'Ads',
  ad: 'Ad',
  ...
  braveAdsTitle: 'Asil Ads',
  braveAdsLaunchTitle: 'Asil Ads has arrived!',
  ...
  braveRewardsTitle: 'Asil Rewards',
  ...
  disabledPanelPrivateText: 'Asil Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'Asil Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable Asil Rewards',
  ...
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the Asil User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no Asil Ads history',
  ...
  relaunch: 'Relaunch',
  remove: 'remove',
  resetWallet: 'Reset Asil Rewards',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined Asil’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsWidgetBraveRewards: 'Asil Rewards',
  saveAd: 'Save',
  saved: 'Saved',
  ...
  serviceText: 'By clicking \'Enable Asil Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on Asil Rewards, you indicate that you have read and agree to the',
  ...
  turnOnRewardsDesc: 'This enables both Asil Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from Asil users.',
  ...
  walletDisconnect: 'Log out from Asil Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your Asil Rewards wallet',
  ...
  walletVerificationNote2: 'Asil Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused Asil Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'Asil Payments is now Asil Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very Asil way to browse the web.',
  whyAsilRewards: 'Why Asil Rewards?',
  whyAsilRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyAsilRewardsDesc2: 'Well, you\'ve come to the right place. Asil welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showAsilStats: 'Show Asil Stats',
  braveTalkWidgetTitle: 'Asil Talk',
