...
const wchar_t kRegPathClients[] = L"Software\\AsilSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\AsilSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\AsilSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\AsilSoftware\\Update";
